<div class="content-loadding" id="loading">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style=" display: block;" width="60px" height="60px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
        <defs>
            <clipPath id="ldio-q1tm1b6f9v-cp">
    ...
    <!-- <div class="title-large">
        Aguarde, estamos enviando seu formulário.
    </div> -->
</div>